...
COPY scripts/oauth_device_approve.py /usr/local/share/grok-reg/oauth_device_approve.py
...
ENV GROK_HOME=/data \
    ...
    GROK_OAUTH_APPROVE_SCRIPT=/usr/local/share/grok-reg/oauth_device_approve.py \
